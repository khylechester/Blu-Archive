...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Block :</span>
            <input type="number" min="0" name="flat" required placeholder="Block Number">
         </div>
         <div class="inputBox">
            <span>Street:</span>
         ...
         <div class="inputBox">
            <span>Region:</span>
            <input type="text" name="state" required placeholder="Region Name">
         </div>
         <div class="inputBox">
            <span>Country :</span>
         ...
         <div class="inputBox">
            ...
            <input type="number" min="0" name="pin_code" required placeholder="Postal Number">
         </div>
      </div>
